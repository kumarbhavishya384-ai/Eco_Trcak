...
const translations = {
  en: {
    ...
    l_start: "<span>\u{1F680}</span> Start Your EcoJourney", l_demo: "<span>▶</span> Watch Demo",
    ...
    l_ctab: "\u{1F30D} Join EcoTrack AI Now — It's Free",
    ...
    electricity_label: "ELECTRICITY", diet_label: "DIET & MEALS", emission_analytics: "\u{1F4C8} Emission Analytics",
    ...
    transport_emissions: "\u{1F697} Transport Emissions (Daily)",
    ...
    electricity_energy: "s Electricity & Energy (Monthly)", home_electricity: "HOME ELECTRICITY",
    ...
    food_diet: "\u{1F37D} Food & Diet (Daily)", food_subtitle: "Track your food impact today.",
    diet_type: "Diet Type", vegan: "Vegan", pure_veg: "Pure Veg", veg_egg: "Veg with Egg", omnivore: "Omnivore", heavy_meat: "Heavy Meat",
    ai_food_scanner: "AI Food Scanner", what_eat: "\u{1F37D} What did you eat today?", how_many_dishes: "How many different dishes?",
    ...
    date_col: "Date", transport_col: "\u{1F697} Transport", electricity_col: "s Electricity", food_col: "\u{1F37D} Food",
    total_co2_col: "Total CO₂", ecoscore_col: "EcoScore", action_col: "Action",
    lb_title: "\u{1F3C6} Campus Leaderboard", this_week: "This Week", all_time: "All Time", your_position: "Your current leaderboard position",
    ...
    smart_recs: "\u{1F4A1} Smart Recommendations", high_impact: "\u{1F525} High Impact", behavioral: "\u{1F4C8} Behavioral Pattern Analysis", eco_challenges: "\u{1F3AF} Eco Challenges",
    ...
    chat_welcome_msg: "Hi! I am your EcoAssistant. You can tell me things like 'I drove 15km in a petrol car today' or 'I had a chicken biryani' and I will log it for you! \u{1F33F}",
  ...
  hi: {
    ...
    l_start: "<span>\u{1F680}</span> यात्रा शुरू करें", l_demo: "<span>▶</span> डेमो देखें",
    ...
    l_ctab: "\u{1F30D} इकोट्रैक मुफ्त में ज्वाइन करें",
    ...
    diet_label: "आहार और भोजन", emission_analytics: "\u{1F4C8} उत्सर्जन विश्लेषण", recent_activity: "हालिया गतिविधि", ai_tips: "AI सुझाव",
    top_warriors: "शीर्ष ईको-योद्धा", view_all: "सभी देखें", calc_title: "कार्बन कैलकुलेटर", step1of3: "चरण 1 / 3", step2of3: "चरण 2 / 3",
    step3of3: "चरण 3 / 3", transport_emissions: "\u{1F697} परिवहन उत्सर्जन (दैनिक)", transport_subtitle: "अपनी दैनिक यात्रा ट्रैक करें।",
    ...
    first_class: "फर्स्ट क्लास", electricity_energy: "s बिजली (मासिक)", home_electricity: "घरेलू बिजली",
    ...
    food_diet: "\u{1F37D} भोजन", food_subtitle: "आज का भोजन दर्ज करें", diet_type: "आहार", vegan: "वीगन", pure_veg: "शाकाहारी",
    ...
    lb_title: "\u{1F3C6} लीडरबोर्ड", this_week: "इस सप्ताह", all_time: "सर्वकालीन", your_position: "आपकी स्थिति",
    ...
    follow_tips: "यदि सुझाव मानें", smart_recs: "\u{1F4A1} स्मार्ट सिफारिशें", high_impact: "\u{1F525} उच्च प्रभाव", behavioral: "पैटर्न विश्लेषण", eco_challenges: "\u{1F3AF} चुनौतियाँ",
    ...
    chat_welcome_msg: "नमस्ते! मैं आपका ईको-असिस्टेंट हूँ। आप मुझे बता सकते हैं जैसे 'मैंने आज पेट्रोल कार में 15 किमी की यात्रा की' और मैं इसे लॉग कर दूँगा! \u{1F33F}",
  ...
  bn: {
    ...
    l_start: "<span>\u{1F680}</span> যাত্রা শুরু করুন", l_demo: "<span>▶</span> ডেমো দেখুন",
    ...
    l_ctab: "\u{1F30D} ইকোট্র্যাক এআই এ যোগ দিন - এটি সম্পূর্ণ বিনামূল্যে",
    ...
    diet_label: "খাদ্য এবং আহার", emission_analytics: "\u{1F4C8} নির্গমন বিশ্লেষণ", recent_activity: "সাম্প্রতিক কাজ", ai_tips: "এআই টিপস",
    top_warriors: "শীর্ষ যোদ্ধা", view_all: "সব দেখুন", calc_title: "ক্যালকুলেটর", step1of3: "ধাপ 1 / 3", step2of3: "ধাপ 2 / 3",
    step3of3: "ধাপ 3 / 3", transport_emissions: "\u{1F697} পরিবহন (দৈনিক)", transport_subtitle: "দৈনন্দিন যাত্রা ট্র্যাক করুন।",
    ...
    first_class: "প্রথম শ্রেণী", electricity_energy: "s বিদ্যুৎ (মাসিক)", home_electricity: "বাড়ির বিদ্যুৎ",
    ...
    food_diet: "\u{1F37D} খাদ্য", food_subtitle: "আজকের খাবার ট্র্যাক করুন", diet_type: "খাদ্যাভ্যাস", vegan: "ভেগান", pure_veg: "নিরামিষ",
    ...
    lb_title: "\u{1F3C6} ক্যাম্পাস লিডারবোর্ড", this_week: "এই সপ্তাহে", all_time: "সর্বকালীন", your_position: "আপনার অবস্থান",
    ...
    follow_tips: "টিপস মানলে", smart_recs: "\u{1F4A1} স্মার্ট সুপারিশ", high_impact: "\u{1F525} গুরুত্বপূর্ণ রূপান্তর", behavioral: "প্যাটার্ন বিশ্লেষণ", eco_challenges: "\u{1F3AF} চ্যালেঞ্জ",
    ...
    chat_welcome_msg: "হ্যালো! আমি আপনার ইকো-অ্যাসিস্ট্যান্ট। আপনি আমাকে বলতে পারেন যেমন 'আমি আজকে পেট্রোল গাড়িতে ১৫ কিমি চালিয়েছি' এবং আমি এটি লগ করে দেব! \u{1F33F}",
  ...
  ta: {
    ...
    l_start: "<span>\u{1F680}</span> தொடங்கவும்", l_demo: "<span>▶</span> டெமோ பார்க்க",
    ...
    l_ctab: "\u{1F30D} EcoTrack AI-இல் இலவசமாக இணையுங்கள்",
    ...
    diet_label: "உணவு", emission_analytics: "\u{1F4C8} உமிழ்வு பகுப்பாய்வு", recent_activity: "சமீபத்திய செயல்கள்", ai_tips: "AI குறிப்புகள்",
    top_warriors: "சிறந்த வீரர்கள்", view_all: "அனைத்தையும் காண்", calc_title: "கால்குலேட்டர்", step1of3: "படி 1 / 3", step2of3: "படி 2 / 3",
    step3of3: "படி 3 / 3", transport_emissions: "\u{1F697} போக்குவரத்து (தினசரி)", transport_subtitle: "தினசரி பயணத்தை பதிவு செய்யவும்",
    ...
    first_class: "முதல் வகுப்பு", electricity_energy: "s மின்சாரம் (மாதாந்திர)", home_electricity: "வீட்டு மின்சாரம்",
    ...
    food_diet: "\u{1F37D} உணவு", food_subtitle: "இன்றைய உணவு", diet_type: "உணவு முறை", vegan: "வீகன்", pure_veg: "சைவம்",
    ...
    lb_title: "\u{1F3C6} லீடர்போர்டு", this_week: "இந்த வாரம்", all_time: "எல்லா நேரமும்", your_position: "உங்கள் இடம்",
    ...
    follow_tips: "குறிப்புகளைப் பின்பற்றினால்", smart_recs: "\u{1F4A1} ஸ்மார்ட் குறிப்புகள்", high_impact: "\u{1F525} அதிக தாக்கம்", behavioral: "பழக்கவழக்கம்", eco_challenges: "\u{1F3AF} சவால்கள்",
    ...
    chat_welcome_msg: "வணக்கம்! நான் உங்கள் சுற்றுச்சூழல் உதவியாளர். 'நான் இன்று பெட்ரோல் காரில் 15 கிமீ சென்றேன்' என்பது போன்ற விஷயங்களைச் சொன்னால் நான் நமக்காக அதைப் பதிவு செய்வேன்! \u{1F33F}",
