...
class EcoChat {
    ...
    initUI() {
            ...
            <div id="ecoChatContainer" class="eco-chat-container">
                <div id="ecoChatWindow" class="eco-chat-window hidden">
                    <div class="chat-header">
                        ...
                        <button onclick="ecoAssistant.toggle()" class="close-chat">Close</button>
                    </div>
                    ...
                    <div class="chat-input-area">
                        ...
                        <button onclick="ecoAssistant.startVoice()" class="voice-btn" title="Voice Input">Voice</button>
        ...
        style.textContent = `
            ...
            .chat-toggle-btn { width: 65px; height: 65px; border-radius: 50%; background: var(--primary); border: 2px solid rgba(255,255,255,0.2); cursor: pointer; color: white; font-size: 1rem; box-shadow: 0 10px 30px rgba(0,212,170,0.4); transition: 0.3s; display: flex; align-items: center; justify-content: center; }
            .chat-toggle-btn:hover { transform: scale(1.1); filter: brightness(1.1); box-shadow: 0 15px 40px rgba(0,212,170,0.6); }
            ...
            .close-chat { background: none; border: none; color: white; cursor: pointer; opacity: 0.7; transition: 0.2s; }
            ...
            .voice-btn, .send-btn { background: none; border: none; cursor: pointer; transition: 0.2s; filter: opacity(0.7); }
            .voice-btn:hover, .send-btn:hover { filter: opacity(1); }
    ...
    async sendMessage() {
        ...
        this.addMessage('assistant', 'Loading...', loadingId);
